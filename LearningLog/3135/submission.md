...
```text
โจทคือ ถ้าอินพุทรันโดนค่าที่กำหนดไว้ให้หยุด หรือโดนค่าเริ่มต้นให้หยุด โดยให้นับว่าวนกี่รอบ
```
...
```text
ช่วยสอน while loop เพราะผม คิดไม่ออกว่า จะใช้ยังไง
```

...
```text
มีอินพุต1บรรทัด หลายตัว ใช้สูตรคณิตหาคำตอบ เเละใช้math ปัดเศษ
```
...
```text
ใช้สูตรคณิตเเละปริ้นออกมาปกติๆ
```
...
```text
ช่วยบอกจุดที่ผิดครับ ตรง ยกกำลังเขียนผิด
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดทั้งหมดด้วยตัวเองครับ
```

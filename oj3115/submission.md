...
```text
การเช็คว่ามี เครื่องarcade ที่ใช้งานกี่เครื่องที่เวลากำหนด โดยเช็คว่ามีเครื่องที่ทำงานไหนบ้าง
```
...
```text
ใช้ for loopเเละ list เพื่อเก็บค่า เเละเช็คโดยใช้ if
```
...
```text
ตอนเเรกผมคิดไม่ออกเลยว่า ควรจะเขียนโจทนี้ไปในทางไหน จนได้นั่งคุยกับเพื่อน เเละช่วยกันคิดโจท จนได้ข้อสรุปว่า ใช้for loop เเละ list เพื่อเก็บค่า เเละใช้.append เพื่อเช็ค
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนcode ด้วยตนเองครับ
```

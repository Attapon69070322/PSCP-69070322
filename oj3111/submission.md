...
```text
ให้คำนวนว่าเป็นสมาชิกหรือไม่ ถ้าเป็นมีส่วนลด ถ้าไม่เป็นต้องถึงขั้นต่ำก่อน
```
...
```text
ใช้ import decimal เเละ round half up เพื่อปัดเศษขึ้น
```
...
```text
ตอนเเรกผมกะจะใช้ if else ปกติ เเต่มันเขียนเเล้วไม่ถูก
ผมเลยไปถามเพื่อน เพื่อนบอกให้ลองใช้ decimal ดู เเละ round halfup
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียน for loop if else เอง 
```
